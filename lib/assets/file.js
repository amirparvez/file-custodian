...
class FCFile{
    ...
    async rename(newName){
        ...
        let isFileWithNewNameAlreadyExists = await this.config.handler.getFile({ name: newName, ext: this.config.ext, folder: this.config.folder }); // This will log a NOTFOUND error
