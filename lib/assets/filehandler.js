...
class FCFileHandler{
    ...
    async newDatabase(options){
        if(options && typeof options === "object"){
            ...
            if(validateConfig.object.system == "mysql" || validateConfig.object.system == "postgresql" || validateConfig.object.system == "mariadb"){ 
                this.database_handler = new FCMySQLHandler({ database: validateConfig.object.database, username: validateConfig.object.username, password: validateConfig.object.password, host: validateConfig.object.host, port: validateConfig.object.port, table_name: validateConfig.object.table_name, proper_delete: validateConfig.object.proper_delete, });
            }else{
                if(validateConfig.object.system == "mongodb"){
                    this.database_handler = new FCMongoDBHandler({ database: validateConfig.object.database, username: validateConfig.object.username, password: validateConfig.object.password, host: validateConfig.object.host, port: validateConfig.object.port, table_name: validateConfig.object.table_name, proper_delete: validateConfig.object.proper_delete, });
                }
            }
