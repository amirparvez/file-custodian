    ...
    async makeLocalFile(path, contents, readStream, doEncrypt, isStream, contentLength, isReplacing = false){
        ...
        try{
            ...
            if(doEncrypt === true){
                ...
                // contentLength does not needs to be increased by 34 for IV since uniqueIV is not pushed into contentStream instead it's written directly to the file...
                ...
                // Timeout is required since content should be passed to the contentStream after it has been piped to the encryptStream.
                setTimeout(() => {
