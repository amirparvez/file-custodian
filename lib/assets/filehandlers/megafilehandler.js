...
class FCMegaFileHandler extends FileHandler{
        ...
        try{
            ...
            if(validateConfig.success){
                ...
                if(file){
                    ...
                    return await self.newFCFile({ name: file.name.replace("."+ext, ""), ext: ext, folder: pathToFile.replace(file.name, ""), handler: self, isEncrypted: false, });
                }
            }
    ...
    // Private function.
    // Copy a file to a folder within this depository.
