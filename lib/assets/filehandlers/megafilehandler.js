...
class FCMegaFileHandler extends FileHandler{
    ...
    async deleteFile(options){
        ...
        if(validateConfig.success){
            ...
            Logger.log("Megafile deletion failed"); return false;
        }else{ Logger.log("Megafile deletion failed"); return false; }
    }
    ...
    async renameFile(options){
        ...
        if(validateConfig.success){
            ...
            Logger.log("Megafile renaming failed"); return false;
        }else{ Logger.log("Megafile renaming failed"); return false; }
    }
