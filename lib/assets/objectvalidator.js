...
class ObjectValidator {
    ...
    async validate(options){
        if(options && typeof options == "object" && options.object && options.against){
            ...
            }catch(error){ Logger.error("ov_io"); return {success: false, object: null,}; }
            ...
            if(response.error === undefined){
                ...
                if(schemaToCheckAgainst){
                    ...
                    }catch(error){ Logger.error("ov_isn"); return {success: false, object: null,}; }
                }else{ Logger.error("ov_isn"); return {success: false, object: null,}; }
            }
        }else { Logger.error("ov_io"); return {success: false, object: null,}; }
    }
}
